...
conn = sqlite3.connect(r'C:\Users\MAACOMPUTER\AppData\Local\Microsoft\Edge\User Data\Default\History') #connect to the google chrome history database "add your path"
cursor = conn.cursor()
